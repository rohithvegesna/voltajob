...
$sql = "SELECT E.Email FROM connection C,jobs J,clients E WHERE C.JobID=J.ID AND C.AgencyID=E.ID AND ((J.Days)-2) < ((($time) - (C.Doe))/86400)";
...
$to = $array['Email'];
$subject = "Voltajob - Connection getting closed!";
$message = <<<EOF
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
				Your connected job is getting closed soon.<br />
              </td>
            </tr>
          </table>
        </td>
