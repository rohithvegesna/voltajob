      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                Thankyou for posting a new job!
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                Your post is waiting for admin conformation. Please sit back and relax while we post your job. You will get a mail as soon as we conform your job. 
              </td>
            </tr>
          </table>
        </td>
