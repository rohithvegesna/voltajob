<?php if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip')) ob_start("ob_gzhandler"); else ob_start();
	...
	$sql = "UPDATE clients SET Status='2' WHERE ID=".$id;
	...
	else
	{
		...
		$to = $array['Email'];
		$subject = "Voltajob - Account Suspended";
$message = <<<EOF
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
                Your account has been suspended due to some reasons.<br>
				Please contact VOLTAJOB at <a href="mailto:admin@voltajob.com">admin@voltajob.com</a>.
              </td>
            </tr>
          </table>
        </td>
