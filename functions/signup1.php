<?php if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip')) ob_start("ob_gzhandler"); else ob_start();
	...
	if($pass == null || $name == null || $mobile == null || $cname == null){
		header('Location: ../register.php?key='.$key.'&email='.$em);exit;die;
	}
	
	$sql = "UPDATE clients SET `Password`='".md5(md5($pass))."', `FullName`='$name', `Mobile`='$mobile', `Company`='$cname', `Website`='$url', `Keye`=NULL WHERE Email='".$em."' and Keye='".$key."'";
	...
	{
		$to = $em;
		$subject = "Voltajob - Account Created";
$message = <<<EOF
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy">
                Your account has been successfully created.<br>Here are the details of your account:<br>
				...
				Please logon to <a href="https://www.voltajob.com">www.voltajob.com</a> post a job. Let us take pleasure in getting your job done.
              </td>
            </tr>
          </table>
        </td>
...
EOF;
		...
		{
			header('Location: ../login.php?msg=Your account has been successfully created please login to post a job');
		}
	}