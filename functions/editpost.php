<?php if (substr_count($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip')) ob_start("ob_gzhandler"); else ob_start();
	...
	$sql = "UPDATE jobs SET Title = '$title', Des = '$desc' WHERE ID=".$id;
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                Your job post has been edited!
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                Your post details:<br>
				Title: $title<br>
				Description: $desc<br><br>
				Please do not share any personal or confidential details in post such as emails phone numbers andcompany details etc,.
              </td>
            </tr>
          </table>
        </td>
