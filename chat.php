...
<head>
	...
	function showUser(str) {
		if (str == "") {
			...
			xmlhttp.open("GET","functions/getchat.php?q="+str,true);
			xmlhttp.send();
		}
	}
	</script>
	<script>
		$(document).ready(function() {
			$('#submit').click(function(e) {
				...
				var chatid = "<?php echo $_POST['chat'];?>";
				
				e.preventDefault();
				$.ajax({
					type: 'POST',
					url: 'functions/newchat.php',
					data: {msg: msg, comp: comp, chatid: chatid},
...
<form autocomplete="off">
	<div class="form-group">
		<input style="width: 100%; float: right !important;" type="text" class="form-control" id="msg" required>
	</div><br><br>
